    ...
    <div class="row align-items-center">
        <div class="col-auto">
            <a href="{{ route('profile.show', $post->user->id) }}">
                @if ($post->user->avatar)
                    <img src="{{ asset('storage/avatars/' . $post->user->avatar) }}" alt="Avatar" class="profile-img">
                @else
        ...
        <div class="col-auto text-end">
            <div class="dropdown">
                ...
                @else
                    <div class="dropdown-menu">
                        @if ($post->user->isFollowed()) {{-- check if the user is followed or not このユーザーをフォローしている人の中に自分がいるかを判定 --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <img src="{{ asset('/storage/images/' . $post->image) }}" alt="{{ $post->image }}" class="img-fluid img-thumbnail">
